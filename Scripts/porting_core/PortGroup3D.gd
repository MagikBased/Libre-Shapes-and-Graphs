...
func add_member(member: Node3D) -> PortGroup3D:
	if member == null:
		return self
...
func add_members(new_members: Array) -> PortGroup3D:
...
func remove_member(member: Node3D) -> PortGroup3D:
...
func clear_members() -> PortGroup3D:
	members.clear()
	return self
...
func apply_positions(positions: Array[Vector3]) -> PortGroup3D:
...
func move_group_to(center_position: Vector3) -> PortGroup3D:
	if members.is_empty():
		return self
