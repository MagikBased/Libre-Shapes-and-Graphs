...
var axes: PortAxes3D
var breather: PortBreatherSurface3D
...
func _ready() -> void:
	...
	breather = PortBreatherSurface3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D breather-surface parity: PortBreatherSurface3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
