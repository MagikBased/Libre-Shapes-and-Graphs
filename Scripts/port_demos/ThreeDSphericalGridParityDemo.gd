...
var sphere_grid: PortSphericalGrid3D
...
func _ready() -> void:
	...
	sphere_grid = PortSphericalGrid3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D spherical-grid parity: PortSphericalGrid3D + orbital markers | RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
