...
var integral_plot: PortIntegralPlot2D
...
func _ready() -> void:
	...
	integral_plot = PortIntegralPlot2D.new()
	...
	x_tracker = PortValueTracker.new(-3.8)
	add_child(x_tracker)
	...
	play_group([
		...
		PortShowCreation.new(integral_plot, 1.2, &"smooth"),
