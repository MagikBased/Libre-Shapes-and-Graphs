...
var axes: PortAxes3D
var conoid: PortPluckerConoid3D
...
func _ready() -> void:
	...
	conoid = PortPluckerConoid3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D plucker-conoid parity: PortPluckerConoid3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
