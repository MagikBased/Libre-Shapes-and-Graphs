...
var axes: PortAxes3D
var curve: PortParametricCurve3D
var mover: MeshInstance3D
var trail: PortTracedPath3D
...
func _ready() -> void:
	...
	curve = PortParametricCurve3D.new()
	curve.width = 0.08
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D parametric-curve parity: PortParametricCurve3D + tracer | RMB orbit, MMB pan, wheel zoom, R reset, F reframe, C clear"
