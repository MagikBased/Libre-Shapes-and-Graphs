...
var terms: Array[PortTextMobject] = []
var brace: PortBrace2D
var brace_label: PortTextMobject
...
func _focus_term(index: int, label_text: String) -> void:
	...
	wait(0.04)
	play(PortFadeToColor.new(terms[i], terms[i].color, Color(0.9, 0.95, 1.0), 0.22, &"smooth"))
