...
var axes: PortAxes3D
var extruded: PortExtrudedPolygon3D
...
func _ready() -> void:
	...
	extruded = PortExtrudedPolygon3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D extruded-polygon parity: PortExtrudedPolygon3D | 1/2/3 shape, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
