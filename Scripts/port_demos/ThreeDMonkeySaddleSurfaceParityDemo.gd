...
var axes: PortAxes3D
var surface: PortMonkeySaddleSurface3D
...
func _ready() -> void:
	...
	surface = PortMonkeySaddleSurface3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D monkey-saddle parity: PortMonkeySaddleSurface3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
