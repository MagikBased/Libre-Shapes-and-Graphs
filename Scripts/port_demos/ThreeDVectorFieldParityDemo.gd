...
var axes: PortAxes3D
var vectors: Array[PortVector3D] = []
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D vector-field parity: animated PortVector3D grid | RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
