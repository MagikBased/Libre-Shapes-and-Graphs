...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D lathe-surface parity: PortLatheSurface3D | 1/2/3 profile, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
