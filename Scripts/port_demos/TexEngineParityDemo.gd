...
var eq_source: PortMathTexMobject
var eq_target: PortMathTexMobject
var eq_features: PortMathTexMobject
var eq_fallback: PortMathTexMobject
var eq_aliases: PortMathTexMobject
var eq_environments: PortMathTexMobject
...
func _ready() -> void:
	...
	eq_source = PortMathTexMobject.new()
	...
	eq_target = PortMathTexMobject.new()
	...
	eq_features = PortMathTexMobject.new()
	...
	eq_fallback = PortMathTexMobject.new()
	...
	eq_aliases = PortMathTexMobject.new()
	...
	eq_environments = PortMathTexMobject.new()
	...
	play(PortWrite.new(eq_source, 1.05, &"linear"))
	wait(0.2)
	...
	wait(0.2)
	play(PortFadeIn.new(eq_features, 0.7, &"smooth"))
	wait(0.2)
	play(PortFadeIn.new(eq_fallback, 0.7, &"smooth"))
	wait(0.2)
	play(PortFadeIn.new(eq_environments, 0.6, &"smooth"))
	wait(0.2)
	play(PortFadeIn.new(eq_aliases, 0.6, &"smooth"))
