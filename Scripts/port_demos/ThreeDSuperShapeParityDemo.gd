...
var axes: PortAxes3D
var super_shape: PortSuperShape3D
...
func _ready() -> void:
	...
	super_shape = PortSuperShape3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D super-shape parity: PortSuperShape3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
