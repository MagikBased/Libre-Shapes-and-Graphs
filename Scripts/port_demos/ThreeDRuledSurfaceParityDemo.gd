...
var axes: PortAxes3D
var ruled_surface: PortRuledSurface3D
...
func _ready() -> void:
	...
	ruled_surface = PortRuledSurface3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D ruled-surface parity: PortRuledSurface3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
