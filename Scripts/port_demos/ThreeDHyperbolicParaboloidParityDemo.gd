...
var axes: PortAxes3D
var surface: PortHyperbolicParaboloid3D
...
func _ready() -> void:
	...
	surface = PortHyperbolicParaboloid3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D hyperbolic-paraboloid parity: PortHyperbolicParaboloid3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
