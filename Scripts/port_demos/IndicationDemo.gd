...
func _ready() -> void:
	...
	play(PortIndicate.new(c, 0.9, &"there_and_back", 1.35, Color.YELLOW))
	wait(0.15)
	play(PortFlashAround.new(t, 0.7, &"there_and_back", Color.GOLD, 3.0, 10.0))
