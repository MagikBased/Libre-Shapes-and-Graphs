...
var axes: PortAxes3D
var tps: PortTriplyPeriodicSurface3D
...
func _ready() -> void:
	...
	tps = PortTriplyPeriodicSurface3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D triply-periodic parity: PortTriplyPeriodicSurface3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
