...
var axes: PortAxes3D
var surface: PortMinimalSurface3D
...
func _ready() -> void:
	...
	surface = PortMinimalSurface3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D minimal-surface parity: PortMinimalSurface3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
