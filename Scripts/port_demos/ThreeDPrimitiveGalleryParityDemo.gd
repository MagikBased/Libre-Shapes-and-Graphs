...
var axes: PortAxes3D
var left_surface: PortSurfaceMesh3D
var right_surface: PortSurfaceMesh3D
var center_cloud: PortPointCloud3D
...
func _ready() -> void:
	...
	center_cloud = PortPointCloud3D.new()
...
func _create_surface(surface_type: StringName, pos: Vector3, color: Color) -> PortSurfaceMesh3D:
	var surface := PortSurfaceMesh3D.new()
...
func _run_timeline() -> void:
	...
	chain.tween_callback(func():
		PortEffects3D.staggered_pulse(self, accent_nodes, 0.05, 1.22, 0.45)
	)
