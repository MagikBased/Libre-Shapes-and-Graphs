...
var axes: PortAxes3D
var umbrella: PortWhitneyUmbrella3D
...
func _ready() -> void:
	...
	umbrella = PortWhitneyUmbrella3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D whitney-umbrella parity: PortWhitneyUmbrella3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
