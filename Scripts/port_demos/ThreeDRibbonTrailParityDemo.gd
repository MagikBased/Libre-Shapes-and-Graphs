...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D ribbon-trail parity: PortRibbonTrail3D | RMB orbit, MMB pan, wheel zoom, R reset, F reframe, C clear"
