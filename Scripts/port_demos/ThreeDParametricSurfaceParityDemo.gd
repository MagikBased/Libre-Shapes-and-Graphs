...
var axes: PortAxes3D
var surface: PortParametricSurface3D
...
func _ready() -> void:
	...
	surface = PortParametricSurface3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D parametric-surface parity: PortParametricSurface3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
