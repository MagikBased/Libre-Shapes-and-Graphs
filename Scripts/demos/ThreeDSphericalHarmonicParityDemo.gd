...
var harmonic: GShapesSphericalHarmonic3D
...
func _ready() -> void:
	...
	harmonic = GShapes.SphericalHarmonic3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D spherical-harmonic parity: GShapesSphericalHarmonic3D | Space/1/2/3/4 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
