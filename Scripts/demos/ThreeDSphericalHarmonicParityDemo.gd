...
var axes: LsgAxes3D
var harmonic: LsgSphericalHarmonic3D
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D spherical-harmonic parity: LsgSphericalHarmonic3D | Space/1/2/3/4 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
