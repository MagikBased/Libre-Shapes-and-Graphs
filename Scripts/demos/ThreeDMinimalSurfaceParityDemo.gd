# Demo: ThreeDMinimalSurfaceParityDemo
# Expected behavior: See PlansAndCopy/DEMO_NOTES.md

extends GShapes3DScene
var axes: GShapesAxes3D
var surface: GShapesMinimalSurface3D
var time_accum: float = 0.0
var mode_index: int = 0
var modes: Array[StringName] = [&"enneper", &"helicoid", &"catenoid"]
var colors: Array[Color] = [
	Color(0.38, 0.9, 1.0, 0.88),
	Color(1.0, 0.68, 0.32, 0.9),
...
func _ready() -> void:
	...
	surface = GShapes.MinimalSurface3D.new()
	surface.mode_name = modes[mode_index]
	surface.u_steps = 96
	surface.v_steps = 96
	surface.domain_radius = 1.25
	surface.scale_factor = 0.95
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D minimal-surface parity: GShapesMinimalSurface3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
