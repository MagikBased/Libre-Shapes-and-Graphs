...
var implicit_surface: GShapesImplicitSurface3D
...
func _ready() -> void:
	...
	implicit_surface = GShapes.ImplicitSurface3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D implicit-surface parity: GShapesImplicitSurface3D | Space/1/2/3/4 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
