...
var axes: LsgAxes3D
var implicit_surface: LsgImplicitSurface3D
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D implicit-surface parity: LsgImplicitSurface3D | Space/1/2/3/4 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
