...
var klein: GShapesKleinBottle3D
...
func _ready() -> void:
	...
	klein = GShapes.KleinBottle3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D klein-bottle parity: GShapesKleinBottle3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
