...
var axes: LsgAxes3D
var extruded: LsgExtrudedPolygon3D
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D extruded-polygon parity: LsgExtrudedPolygon3D | 1/2/3 shape, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
