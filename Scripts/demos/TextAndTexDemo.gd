...
func _ready() -> void:
	...
	text_a = GShapes.TextMobject.new()
	...
	text_b = GShapes.TextMobject.new()
	...
	tex_line = GShapes.TexMobject.new()
	...
	play(GShapes.Write.new(text_a, 1.0, &"linear"))
	wait(0.3)
	...
	wait(0.2)
	play(GShapes.FadeIn.new(tex_line, 0.7, &"smooth"))
