...
func _ready() -> void:
	...
	demo_scenes = GShapes.DemoCatalog.get_visual_demos()
	profile_names = GShapes.RenderProfiles.get_profile_names()
	_refresh_labels()
...
func _refresh_labels() -> void:
	...
	var profile: Dictionary = GShapes.RenderProfiles.get_profile(profile_name)
	var base_name: String = GShapes.RenderProfiles.build_output_basename(scene_path, profile_name)
