...
var axes: LsgAxes3D
var shell: LsgSeashellSurface3D
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D seashell-surface parity: LsgSeashellSurface3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
