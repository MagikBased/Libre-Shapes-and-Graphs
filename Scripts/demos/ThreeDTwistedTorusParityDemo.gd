...
var torus: GShapesTwistedTorus3D
...
func _ready() -> void:
	...
	torus = GShapes.TwistedTorus3D.new()
...
func _create_overlay() -> void:
	...
	add_child(layer)
	var label := Label.new()
	label.text = "3D twisted-torus parity: GShapesTwistedTorus3D | Space/1/2/3 mode, RMB orbit, MMB pan, wheel zoom, R reset, F reframe"
