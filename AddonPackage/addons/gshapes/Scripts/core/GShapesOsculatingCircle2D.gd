class_name GShapesOsculatingCircle2D
extends Node2D
...
func rebuild() -> void:
	...
	var p0: Vector2 = GShapesPathUtils.sample_polyline(pts, a0, false)
	var p1: Vector2 = GShapesPathUtils.sample_polyline(pts, a1, false)
	var p2: Vector2 = GShapesPathUtils.sample_polyline(pts, a2, false)
